...
const Navbar: React.FC = () => {
    return (
        <nav className='bg-black text-white p-4 sticky top-0 z-50 border-b-2 border-b-white h-[4.5rem] px-[7vw]'>
            <div className='mx-auto flex justify-between items-center md:pt-1 md:pb-1'>
                ...
                <div className='flex space-x-16 text-2xl justify-center w-full font-bold'>
                    ...
                    <Link className='hover:transition-colors hover:text-gray-400 duration-300' href='/buy-tickets'>Buy
                        tickets</Link>
